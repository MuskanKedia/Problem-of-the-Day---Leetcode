...
//Time Complexity : O((e + q) log n), where e is the number of edges in the graph, q is the number of queries, and n is the size of the input array.
//Space Complexity : O(max(n, e, q))
